...
export default function Chapter_4({ activeMenu, goToChapter, next }) {
    ...
    const [avatarList, setAvatarList] = useState([avatar1, avatar2, avatar3, avatar1, avatar2, avatar3, avatar1, avatar2, avatar3, avatar1, avatar2, avatar3, avatar1, avatar2, avatar3])
